...
public class MTJornada extends ModeloTabla<Jornada>{
    ...
    public Object getValorEn(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex){
            ...
            case 2:
                return jornada.getRefrigerioHS() == null || !jornada.isConRefrigerio() ? null : dtHora.format(jornada.getRefrigerioHS());
            case 3:
                return jornada.getRefrigerioHE() == null || !jornada.isConRefrigerio() ? null : dtHora.format(jornada.getRefrigerioHE());
            case 4:
